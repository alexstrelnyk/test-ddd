...
$a = ($this->privates['doctrine.orm.default_yml_metadata_driver'] ?? $this->load('getDoctrine_Orm_DefaultYmlMetadataDriverService.php'));

$instance->addDriver($a, 'App\\Domain\\Client\\Entity');
$instance->addDriver($a, 'App\\Domain\\ShippingAddress\\Entity');
