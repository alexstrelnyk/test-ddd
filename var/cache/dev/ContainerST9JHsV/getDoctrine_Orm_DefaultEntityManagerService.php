...
$c = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver([($this->targetDirs[3].'/config/doctrine_mapping/Client') => 'App\\Domain\\Client\\Entity', ($this->targetDirs[3].'/config/doctrine_mapping/ShippingAddress') => 'App\\Domain\\ShippingAddress\\Entity']);
$c->setGlobalBasename('mapping');

$b->addDriver($c, 'App\\Domain\\Client\\Entity');
$b->addDriver($c, 'App\\Domain\\ShippingAddress\\Entity');

$a->setEntityNamespaces(['App\\Domain\\Client' => 'App\\Domain\\Client\\Entity', 'App\\Domain\\ShippingAddress' => 'App\\Domain\\ShippingAddress\\Entity']);
